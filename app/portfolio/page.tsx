        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6 text-foreground">
              Our Work <span className="text-primary">Speaks Volumes</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {portfolioItems.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group relative bg-card rounded-lg overflow-hidden border border-border hover:border-primary transition-all duration-300"
              >
                <div className="relative h-64 overflow-hidden">
                  ...
                  >
                    <div className="w-10 h-10 bg-primary rounded-full flex items-center justify-center hover:opacity-80 transition-opacity">
          ...
          >
            ...
            <Link href="/#consultation-form">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-primary text-primary-foreground rounded-full font-semibold hover:opacity-90 transition-opacity inline-flex items-center gap-2"
              >
