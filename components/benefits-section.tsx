    ...
    <section className="py-20 bg-zinc-900">
      <div className="container mx-auto px-4 lg:px-8">
        <h2 className="text-3xl lg:text-4xl font-bold mb-4 animate-fade-in-up">
          Discover the <span className="text-red-500">Benefits</span> with Us
        </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mt-12">
          ...
          <div className="relative animate-scale-in">
            <div className="aspect-[4/3] rounded-lg overflow-hidden">
              ...
              <div className="absolute top-8 left-8 bg-red-500 text-white px-6 py-3 rounded font-bold text-lg">
                digitalinventorybd
              </div>
            </div>
          </div>
